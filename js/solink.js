// Wait until the document is ready
            $(function () {
                ...
                var apiKeyForm = '<form class="apiForm">'
                ...
                var apiLinkForm = '<form class="apiForm">'
                                ...
                                + '<button id="submitLinks" class="btn btn-info btn-large">Submit</button>'
                                + '<hr />'
                                + '<div id="linkForm">'
                                + '</div>'
                                + '</form>';
                ...
                $(document).on('click', '#submitLinks', function (e) {
                    ...
                    $items.each(function () {
                        ...
                        $inputs.each(function () { links.push($(this)) });
                    });
